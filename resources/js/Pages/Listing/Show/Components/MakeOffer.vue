        ...
        <div>
            <form @submit.prevent="makeOffer">
                ...
                <input 
                    ...
                    class="mt-2 w-full h-4 bg-gray-200 dark:bg-gray-700 runded-lg appearence-none cursor-pointer"
                />
                <button tupe="submit" class="btn-outline w-full mt-2 text-sm">Make an offer</button>
            </form>
        </div>
