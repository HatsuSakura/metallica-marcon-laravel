...
<section>
<Link @click="closeDrawer" :href="route('vehicle.create')" class="btn btn-primary mb-4">
    Nuovo Automezzo
</Link>
</section>
...
<section>
    ...
    <Box v-for="vehicle in props.vehicles.data" class="col-span-6">
        ...
        <div class="flex flex-row justify-end gap-2">
            <Link
            :href="route('vehicle.edit', {vehicle: vehicle.id} )"
            method="get"
            as="button"
            ...
            <Link
                :href="route('vehicle.destroy', {vehicle: vehicle.id} )"
                method="delete"
                as="button"
