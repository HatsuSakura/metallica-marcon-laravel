        ...
        <div class="flex flex-col gap-1 w-2/3 mx-auto">
            ...
            <div class="flex flex-row justify-between items-stretch">
                ...
                <div v-if="showCraneOperator">
                    <label class="label" for="is_crane_operator">
                        Operatore ragno
                    </label>
                    <input v-model="form.is_crane_operator" id="is_crane_operator" type="checkbox" class="toggle" />
                </div>
...
-->
    ...
    const form = useForm({
        ...
        is_crane_operator: Boolean(props.user?.is_crane_operator),
    ...
    const update = () => {
        if (!showCraneOperator.value) {
            form.is_crane_operator = false;
        }
