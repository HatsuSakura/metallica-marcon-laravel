...
<section>
<Link @click="closeDrawer" :href="route('relator.journey.create')" class="btn btn-primary">
    <font-awesome-icon :icon="['fas', 'map-location-dot']" class="text-2xl"/>
    Crea nuovo Cargo Cassone
</Link>
</section>
...
<section class="mt-4">
    ...
    <EmptyState v-if="!props.journeys.data">
        Nessun Cargo Cassone trattato
    </EmptyState>
    <div v-else>
    <Box v-for="journey in props.journeys.data">
        <div class="flex flex-row justify-between items-center">
            ...
            <div>
                <Link
                    :href="route('relator.journey.edit', {journey: journey.id} )"
                    method="get"
                    as="button"
                ...
                <Link
                    :href="route('relator.journey.destroy', {journey: journey.id} )"
                    method="delete"
                    as="button"
