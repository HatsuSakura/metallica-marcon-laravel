...
<Box>
    <div class="flex flex-row justify-between items-center">
        ...
        <div>
            <Link
                :href="route('journeyCargo.show', {journeyCargo: props.journeyCargo.id} )"
                method="get"
                as="button"
                class="btn btn-primary btn-circle btn-outline mr-2"
            >
                <font-awesome-icon :icon="['fas', 'eye']" class="text-lg" />
            </Link>
            <Link
                :href="route('journeyCargo.edit', {journey: props.journeyCargo.journey_id} )"
                method="get"
                as="button"
                class="btn btn-primary btn-circle btn-outline mr-2"
            >
