...
class VehicleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vehicle.index')->with('success', 'Automezzo inserito con successo!');
    }
    ...
    public function update(Request $request, Vehicle $vehicle)
    {
        ...
        return redirect()->route('vehicle.index')->with('success', 'Automezzo modificato con successo!');
    }
