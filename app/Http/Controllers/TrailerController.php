...
class TrailerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('trailer.index')->with('success', 'Rimorchio creato con successo!');
    }
    ...
    public function update(Request $request, Trailer $trailer)
    {
        ...
        return redirect()->route('trailer.index')->with('success', 'Rimorchio modificato con successo!');
    }
