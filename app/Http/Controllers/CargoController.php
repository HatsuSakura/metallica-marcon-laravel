...
class CargoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cargo.index')->with('success', 'Tipo cassone creato correttamente!');
    }
    ...
    public function update(Request $request, Cargo $cargo)
    {
        ...
        return redirect()->route('cargo.index')->with('success', 'Cassone modificato con successo!');
    }
