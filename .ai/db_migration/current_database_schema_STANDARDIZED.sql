...
CREATE TABLE `cargos` (
  ...
  `crate_slots` int(11) DEFAULT NULL,
  `spazi_bancale` int(11) DEFAULT NULL,
  `pallet_slots` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `journeys` (
  ...
  `primary_warehouse_download_at` timestamp NULL DEFAULT NULL,
  `secondary_warehouse_id` bigint(20) unsigned DEFAULT NULL,
  `secondary_warehouse_download_at` timestamp NULL DEFAULT NULL,
  `vehicle_id` bigint(20) unsigned NOT NULL,
  `vehicle_cargo_id` bigint(20) unsigned DEFAULT NULL,
  `trailer_id` bigint(20) unsigned DEFAULT NULL,
  `trailer_cargo_id` bigint(20) unsigned DEFAULT NULL,
  `driver_id` bigint(20) unsigned NOT NULL,
  `logistics_user_id` bigint(20) unsigned DEFAULT NULL,
  `status` enum('creato','attivo','eseguito','chiuso') DEFAULT NULL,
...
CREATE TABLE `journey_cargos` (
  ...
  `cargo_location` enum('vehicle','trailer','fulfill') DEFAULT NULL,
  `is_grounded` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `journey_cargo_order_item` (
  ...
  `is_double_load` tinyint(1) NOT NULL DEFAULT 0,
  `download_warehouse_id` bigint(20) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `journey_events` (
  ...
  `status` enum('planned','in_progress','done','skipped','cancelled') DEFAULT NULL,
  ...
  KEY `journey_events_state_created_at_index` (`created_at`),
...
CREATE TABLE `orders` (
  ...
  `status` enum('creato','pianificato','eseguito','scaricato','chiuso') DEFAULT NULL,
  `cargo_location` enum('vehicle','trailer','fulfill') DEFAULT NULL,
  `expected_withdraw_at` timestamp NULL DEFAULT NULL,
  `actual_withdraw_at` timestamp NULL DEFAULT NULL,
  `has_crane` tinyint(1) DEFAULT NULL,
  `crane_operator_user_id` bigint(20) unsigned DEFAULT NULL,
  `machinery_time_minutes` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `order_holders` (
  ...
  `filled_holders_count` int(11) DEFAULT NULL,
  `empty_holders_count` int(11) DEFAULT NULL,
  `total_holders_count` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `order_items` (
  ...
  `has_adr` tinyint(1) DEFAULT NULL,
  `adr_un_code` varchar(191) DEFAULT NULL,
  `adr_hp` varchar(191) DEFAULT NULL,
  `adr_lotto` varchar(191) DEFAULT NULL,
  `adr_lot_code` varchar(191) DEFAULT NULL,
  ...
  `warehouse_download_worker_id` bigint(20) unsigned DEFAULT NULL,
  `warehouse_download_at` timestamp NULL DEFAULT NULL,
  ...
  `selection_duration_minutes` double DEFAULT NULL,
  `is_crane_eligible` tinyint(1) DEFAULT NULL,
  `machinery_time_fraction` int(11) DEFAULT NULL,
  `machinery_time_share` int(11) DEFAULT NULL,
  ...
  `is_adr_total` tinyint(1) DEFAULT NULL,
  `adr_esenzione_totale` tinyint(1) DEFAULT NULL,
  `has_adr_total_exemption` tinyint(1) DEFAULT NULL,
  `adr_esenzione_parziale` tinyint(1) DEFAULT NULL,
  `has_adr_partial_exemption` tinyint(1) DEFAULT NULL,
  `status` enum('creato','caricato','scaricato','lavorazione','classificato','chiuso','trasbordo') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sites` (
  ...
  `customer_id` bigint(20) unsigned NOT NULL,
  `name` varchar(191) DEFAULT NULL,
  `site_type` varchar(191) DEFAULT NULL,
  `is_main` tinyint(1) DEFAULT 1,
  `address` varchar(191) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
  `calculated_risk_factor` double DEFAULT NULL,
  `days_until_next_withdraw` bigint(20) DEFAULT NULL,
  `has_muletto` tinyint(1) NOT NULL DEFAULT 0,
  `has_electric_pallet_truck` tinyint(1) DEFAULT NULL,
  `has_manual_pallet_truck` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `customer_id` bigint(20) unsigned DEFAULT NULL,
  `is_crane_operator` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `withdraws` (
  ...
  `driver_id` bigint(20) unsigned NOT NULL,
  `created_by_user_id` bigint(20) unsigned DEFAULT NULL,
  `is_manual_entry` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
